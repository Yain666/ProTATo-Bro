...
@export var turret_effect: Resource
@export var landmines_effect: Resource
@export var gold_sprites: Array
@export var gold_pickup_sounds: Array # (Array, Resource)
@export var gold_alt_pickup_sounds: Array # (Array, Resource)
@export var level_up_sound: Resource
@export var run_won_sounds: Array # (Array, Resource)
@export var run_lost_sounds: Array # (Array, Resource)
@export var end_wave_sounds: Array # (Array, Resource)
...
func clean_up_room() -> void :
	...
	_wave_cleared_label.start(Callable(_is_wave_failed, _is_run_lost).bind(_is_run_won))
